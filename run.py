#!/usr/bin/env python3
"""Run ONE problem of appworld through TrustedRouter and emit a reproducibility bundle.
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one appworld problem via TrustedRouter")
